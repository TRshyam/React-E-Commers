...
export default function Card({ imageSrc, content }) {
    return (
        ...
        // </div>
<>
    <div className='w-[75%] sm:w-[75%] md:w-[75%] lg:w-[50%] xl:w-[60%] h-[250px] xl:h-[300px] bg-white rounded-md relative overflow-hidden shadow-xl m-6 hover:scale-105 hover:shadow-2xl hover:bgb transition-transform duration-300'>
